...
import estruturas.listaDupla.DoubleLinkedListImpl;
...
public class MenuListaDupla {
    ...
    public void iniciar() {
        DoubleLinkedListImpl<Integer> lista =
    ...
    private void inserir(DoubleLinkedListImpl<Integer> lista) {
    ...
    private void remover(DoubleLinkedListImpl<Integer> lista) {
        if (lista.isEmpty()) {
            System.out.println("\nA lista está vazia.");
            return;
        }
    ...
    private void pesquisar(DoubleLinkedListImpl<Integer> lista) {
        int elemento = lerInteiro(
    ...
    private void exibirLista(DoubleLinkedListImpl<Integer> lista) {
        System.out.println(
    ...
    private void demonstrarOperacoes() {
        DoubleLinkedListImpl<Integer> demonstracao =
                new DoubleLinkedListImpl<>();

        demonstracao.insert(8);
        demonstracao.insert(16);
        demonstracao.insert(24);
        demonstracao.insert(32);

        System.out.println();
        System.out.println("Elementos inseridos: 8, 16, 24 e 32");
        System.out.println(
                "Lista: "
        ...
        System.out.println(
                "Pesquisa pelo 24: "
                        + demonstracao.search(24)
        );

        demonstracao.remove(16);

        System.out.println(
                "Depois de remover 16: "
                        + Arrays.toString(demonstracao.toArray())
        );
